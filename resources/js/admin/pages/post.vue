...
export default {
    ...
    methods:{
        ...
        //     let r = confirm('Are you sure you want to delete this post from the system?');
        //     if(r){
        //         axios.post('app/delete_todo/'+post.id, {_method: 'DELETE'})
        //                 .then(response => {
        //                     this.flashSuccessAndReload('Successfully deleted post');
        //                 })
        //                 .catch(errors => {
